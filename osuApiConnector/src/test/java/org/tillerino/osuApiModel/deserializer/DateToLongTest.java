...
public class DateToLongTest {
	...
	public void testStringDateDeserialization() throws Exception {
		ClassWithLongDateField readValue = jackson.readValue("{ \"dateField\": \"1970-01-01 00:00:01\" }",
				ClassWithLongDateField.class);
	...
	public void roundTrip() throws Exception {
		...
		assertThat(jackson.readValue(jackson.writeValueAsString(value), ClassWithLongDateField.class)).isEqualTo(value);
	}

	@Test
	public void unexpectedFieldType() throws Exception {
		assertThatThrownBy(() -> jackson.readValue("{ \"dateField\": true }",
				ClassWithLongDateField.class))
